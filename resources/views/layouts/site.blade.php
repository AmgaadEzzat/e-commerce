                    ...
                    <div class="account-list-content">
                        <div>
                            <a class="login" href="login-1.html" rel="nofollow"
                               title="Log in to your customer account"><i class="fa fa-sign-in">
                                </i>Sign in</a>
                        </div>
                        <div>
            ...
            <div class="w-100">
                <div class="item-language current">
                    <a href="index.htm?home=home_3" class="d-flex align-items-center">
                        <img class="img-fluid mr-2" src="../img/l/1.jpg"
                             alt="English (English)"width="16" height="11">
                        <span>English</span></a>
                </div>
                ...
                <div class="item-language">
                    <a href="http://demo.bestprestashoptheme.com/savemart/es/?home=home_3"
                       class="d-flex align-items-center">
                        <img class="img-fluid mr-2" src="../img/l/3.jpg"
                            alt="Español (Spanish)" width="16" height="11">
                        <span>Español</span></a>
                </div>
                <div class="item-language">
                    <a href="http://demo.bestprestashoptheme.com/savemart/it/?home=home_3"
                       class="d-flex align-items-center"><img class="img-fluid mr-2" src="../img/l/4.jpg"
                            alt="Italiano (Italian)" width="16" height="11">
                ...
                <div class="item-language">
                    <a href="http://demo.bestprestashoptheme.com/savemart/ar/?home=home_3"
                       class="d-flex align-items-center"><img class="img-fluid mr-2" src="../img/l/6.jpg"
                            alt="اللغة العربية (Arabic)" width="16" height="11">
...
<div id="stickymenu_bottom_mobile" class="d-flex align-items-center justify-content-center hidden-md-up text-center">
    ...
    <div class="stickymenu-item"><a href="login-2.html"><i class="zmdi zmdi-favorite-outline"></i>
            <span>Wishlist</span></a>
    </div>
    <div class="stickymenu-item"><a href="#" class="nov-toggle-page" data-target="#mobile-pageaccount">
            <i class="zmdi zmdi-account-o"></i><span>Account</span></a></div>
</div>
