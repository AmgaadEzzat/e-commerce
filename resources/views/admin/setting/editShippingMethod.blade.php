                            ...
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title" id="basic-layout-form">
                                        {{__('admin/shippingMethod.Modify the delivery method')}}</h4>
                                        ...
                                        <form class="form" action="{{route('update-shipping-method',$shippingMethod->id)}}"
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label for="projectinput1">{{__('admin/shippingMethod.Name')}}</label>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label for="projectinput1">
                                                                {{__('admin/shippingMethod.Delivery value')}}</label>
                                            ...
                                            <div class="form-actions">
                                                <button type="button" class="btn btn-warning mr-1"
                                                    ...
                                                    <i class="ft-x"></i>{{__('admin/shippingMethod.Back')}}
                                                </button>
